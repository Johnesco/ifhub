...
A theme named after a system uses that system's palette: MS-DOS is CGA light gray on black with the Norton blue for fills, Commodore 64 uses the C64 palette (light gray text, light blue borders and status line, cyan and yellow accents), Amiga is Workbench 1.3 blue, white and orange fills, Atari 800 is GRAPHICS 0 light blue on blue, TRS-80 is the Model III's white-gray phosphor on black, CP/M (Kaypro) is green phosphor on black, Apple II is green phosphor, Macintosh and Atari ST are black on white.
