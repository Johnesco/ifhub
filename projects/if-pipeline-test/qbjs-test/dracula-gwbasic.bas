...
2 GOSUB 193
3 GOSUB 188
4 LOCATE 20,25:PRINT "Do you need instructions Y / N ";:INPUT A$:A$=LEFT$(A$+" ",1):GOSUB 215
...
105 PRINT TAB(27);:PRINT USING "The time is now ##:##";T2,T1:GOTO 38
106 REM    ********    DROP    **********
107 IF S<7 THEN 56
...
127 IF OI=0 THEN PRINT TAB(27);"Too much rust ... ";:GOTO 119
...
147 PRINT:PRINT TAB(14);:GOSUB 218:PRINT "Congratulations ! ";:GOSUB 230:PRINT "You have KILLED Dracula ";:PRINT USING "at ##:## p.m.";T2,T1:GOTO 156
148 REM   *********    OIL     ***********
...
186 GOSUB 215
187 RETURN
188 REM ********    WELCOME TEXT    ********
189 LOCATE 6,35:PRINT "W E L C O M E"
190 LOCATE 8,27:PRINT "TO DRACULA'S CASTLE ADVENTURE"
191 LOCATE 13,33:GOSUB 221:PRINT"ENTER IF YOU DARE";:GOSUB 230
192 RETURN
193 REM ***********       CASTLE        **************
194 GOSUB 215
...
212 RETURN
213 REM ***************  GW-BASIC DISPLAY ROUTINES  ****************
214 REM  Adapted from original VT52 escape codes for GW-BASIC/PC-BASIC/QB64
215 REM ************     CLS     *********
216 CLS:RETURN
217 REM
218 REM ***********     REVERSE VIDEO (was FLASH)   *************
219 COLOR 0,7:RETURN
220 REM
221 REM ***********     REVERSE VIDEO (was REVERSE FLASH)    **************
222 COLOR 0,7:RETURN
223 REM
224 REM **********      EMPHASIS (was UNDERLINE)   **************
225 COLOR 14,0:RETURN
226 REM
227 REM ***********     NORMAL TEXT (was LOW LIGHT)      *************
228 COLOR 7,0:RETURN
229 REM
230 REM ***********     BRIGHT TEXT (was RESET/BOLD)       **********
231 COLOR 15,0:RETURN
232 REM
